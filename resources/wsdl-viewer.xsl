...
<xsl:template match="ws:service|ws2:service" mode="service-start">
   ...
   <xsl:template match="ws2:endpoint" mode="service">
		...
		<xsl:choose>
	     ...
	     <div class="label">WSDL location:</div>
	     <div class="value"><a href="{@address}?wsdl" target="_blank"><xsl:value-of select="@address"/>?wsdl</a></div>
   ...
   <xsl:template match="ws:port" mode="service">
	     ...
	     <div class="label">WSDL location:</div>
	     <div class="value"><a href="{*[local-name() = 'address']/@location}?wsdl" target="_blank"><xsl:value-of select="*[local-name() = 'address']/@location"/>?wsdl</a></div>
	     <div class="label">Endpoint:</div>
